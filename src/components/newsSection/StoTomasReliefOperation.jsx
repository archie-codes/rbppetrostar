...
// const images = [
//     "/relief_operations/sto_tomas/sto-tomas_1 (1).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (2).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (3).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (4).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (5).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (6).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (7).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (8).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (9).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (10).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (11).jpg",
//     "/relief_operations/sto_tomas/sto-tomas_1 (12).jpg",

// ];

// const StoTomasReliefOperation = () => {
...
//                             <img src="/relief_operations/sto_tomas/sto-tomas_1.jpg" alt="" className="z-0 transition-all duration-300 hover:scale-110" loading="lazy" />
//                         </div>
...
//                             </span>
//                             <br />
//                             <span className="text-gray-800 pl-[30px]">Sto Tomas, San Fernando, Pampanga</span>
//                             <br />
...
// export default StoTomasReliefOperation
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 z-10" data-aos="fade-right">
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            Serving the community of Brgy. Sto. Tomas with dedication and care. A testament to our commitment to helping others.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-5 inline-flex flex-col sm:flex-row gap-6 sm:items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Sto. Tomas, Pampanga</p>
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl -rotate-2 transition-transform hover:rotate-0 duration-700 group">
                            ...
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-bold text-xl">San Fernando Mission</p>
                                <p className="text-white/80 text-sm mt-1">Brgy. Sto. Tomas</p>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        ...
                        <div className="mt-4 flex flex-col items-center text-white/80">
                            <p className="font-semibold text-lg">Sto. Tomas Relief Ops</p>
