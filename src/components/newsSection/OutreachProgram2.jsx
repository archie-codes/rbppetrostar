...
// const images = [
//     "/outreach_program_2/op (1).JPG",
//     "/outreach_program_2/op (2).JPG",
//     "/outreach_program_2/op (3).jpg",
//     "/outreach_program_2/op (4).JPG",
//     "/outreach_program_2/op (5).JPG",
//     "/outreach_program_2/op (6).JPG",
//     "/outreach_program_2/op (7).JPG",
//     "/outreach_program_2/op (8).JPG",
//     "/outreach_program_2/op (9).JPG",
//     "/outreach_program_2/op (10).jpg",
//     "/outreach_program_2/op (11).JPG",
//     "/outreach_program_2/op (12).JPG",
//     "/outreach_program_2/op (13).jpg",

// ];

// const OutreachProgram2 = () => {
...
//                             <img src="/outreach_program_2/op (15).jpg" alt="" className="z-0 transition-all duration-300 hover:scale-110" loading="lazy" />
//                         </div>
//                         <div className="p-6 space-y-2 lg:col-span-5">
//                             <h3 className="text-2xl text-gray-800 font-semibold sm:text-4xl mb-3">RBP Petrostar Outreach Program</h3>
...
//                                 </svg>
//                                 Burog Integrated School
//                             </span>
//                             <br />
//                             <span className="text-gray-800 pl-[30px]">Sitio Burog, Porac, Pampanga</span>
//                             <br />
...
// export default OutreachProgram2;
...
// Image Array - Exact paths from your code
const images = [
    "/outreach_program_2/op (1).JPG",
    "/outreach_program_2/op (2).JPG",
    "/outreach_program_2/op (3).jpg",
        ...
        <main className="min-h-screen bg-neutral-50 font-sans selection:bg-red-100 selection:text-red-900">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 z-10" data-aos="fade-right">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-red-600 font-bold tracking-widest text-xs uppercase flex items-center gap-2">
                                <HeartHandshake size={14}/> Gift Giving
                            </span>
                        </div>
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            Bringing joy and support to the students of Burog Integrated School. A day dedicated to sharing blessings and building a brighter future.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-5 inline-flex flex-col sm:flex-row gap-6 sm:items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Sitio Burog, Porac, Pampanga</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">December 17, 2024</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl -rotate-2 transition-transform hover:rotate-0 duration-700 group">
                            {/* Using image 15 (op 15.jpg) as it was the featured one in the original code */}
                            <img 
                                src="/outreach_program_2/op (15).jpg" 
                                className="w-full h-[500px] object-cover object-center transition-transform duration-700 group-hover:scale-105" 
                                alt="Outreach Program Main" 
                            />
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-90"></div>
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-bold text-xl">Burog Integrated School</p>
                                <p className="text-white/80 text-sm mt-1">Sharing smiles with the students</p>
                            </div>
                        </div>
            ...
            <section className="px-4 pb-24 max-w-[1600px] mx-auto">
                <div className="flex justify-between items-end mb-10 px-2 border-b border-gray-200 pb-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Gallery of Smiles</h2>
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        ...
                        <div className="mt-4 flex flex-col items-center text-white/80">
                            <p className="font-semibold text-lg">Porac Outreach</p>
