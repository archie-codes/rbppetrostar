...
// const images = [
//     "/team_building 2/tb (1).jpg",
//     "/team_building 2/tb (2).jpg",
//     "/team_building 2/tb (3).jpg",
//     "/team_building 2/tb (4).jpg",
//     "/team_building 2/tb (5).jpg",
//     "/team_building 2/tb (6).jpg",
//     "/team_building 2/tb (7).jpg",
//     "/team_building 2/tb (8).jpg",
//     "/team_building 2/tb (9).jpg",
//     "/team_building 2/tb (10).jpg",
//     "/team_building 2/tb (11).jpg",
//     "/team_building 2/tb (12).jpg",
//     "/team_building 2/tb (13).jpg",
//     "/team_building 2/tb (14).jpg",
//     "/team_building 2/tb (15).jpg",
//     "/team_building 2/tb (16).jpg",
//     "/team_building 2/tb (17).jpg",
//     "/team_building 2/tb (18).jpg",
//     "/team_building 2/tb (19).jpg",
//     "/team_building 2/tb (20).jpg",
//     "/team_building 2/tb (21).jpg",
//     "/team_building 2/tb (22).jpg",
// ];

// const TeamBuildingBatangas = () => {
...
//                         <div className="flex items-center justify-center overflow-hidden object-cover h-64 rounded-lg sm:h-96 lg:col-span-7">
//                             <img src="/team_building 2/tb (19).jpg" alt="" className=" h-auto object-cover z-0 transition-all duration-300 hover:scale-110" loading="lazy" />
//                         </div>
//                         <div className="p-6 space-y-2 lg:col-span-5">
//                             <h3 className="text-2xl text-gray-800 font-semibold sm:text-4xl mb-3">RBP Team Building</h3>
...
//                                 </svg>
//                                 Batangas Lakelands - Leviste Highway, Brgy. Malabanan, Balete, Batangas, Philippines
//                             </span>
//                             <br />
...
//                                     className="h-full w-auto object-cover rounded-xl transform transition-transform duration-300 hover:scale-110"
//                                     loading="lazy"
//                                 />
//                             </div>
//                         ))}
...
//     )
// }
// export default TeamBuildingBatangas;
...
// Images data
const images = [
    "/team_building 2/tb (1).jpg", "/team_building 2/tb (2).jpg",
    "/team_building 2/tb (3).jpg", "/team_building 2/tb (4).jpg",
    "/team_building 2/tb (5).jpg", "/team_building 2/tb (6).jpg",
    "/team_building 2/tb (7).jpg", "/team_building 2/tb (8).jpg",
    "/team_building 2/tb (9).jpg", "/team_building 2/tb (10).jpg",
    "/team_building 2/tb (11).jpg", "/team_building 2/tb (12).jpg",
    "/team_building 2/tb (13).jpg", "/team_building 2/tb (14).jpg",
    "/team_building 2/tb (15).jpg", "/team_building 2/tb (16).jpg",
    "/team_building 2/tb (17).jpg", "/team_building 2/tb (18).jpg",
    "/team_building 2/tb (19).jpg", "/team_building 2/tb (20).jpg",
    "/team_building 2/tb (21).jpg", "/team_building 2/tb (22).jpg",
];

const TeamBuildingModern = () => {
    const [isOpen, setIsOpen] = useState(false);
    const [currentIndex, setCurrentIndex] = useState(0);
    const [scrolled, setScrolled] = useState(false);

    // Handle scroll for navbar effects (if you have a sticky nav)
    useEffect(() => {
    ...
    return (
        <main className="min-h-screen bg-neutral-50 font-sans selection:bg-red-100 selection:text-red-900">
            ...
            {/* --- SECTION 1: IMMERSIVE HERO --- 
                Modern trend: Large typography, high contrast, overlapping elements.
            */}
            <section className="relative w-full pt-32 pb-20 px-6 lg:px-12 lg:pt-40 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    
                    {/* Typography Side */}
                    <div className="lg:col-span-6 z-10" data-aos="fade-up">
                        <div className="flex items-center gap-2 mb-6">
                            <span className="h-px w-12 bg-red-600"></span>
                            <span className="text-red-600 font-bold tracking-widest text-xs uppercase">Official Event</span>
                        </div>
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            A showcase of resilience and teamwork at Batangas Lakelands. Witness the highlights of our journey.
                        </p>

                        {/* Glassmorphic Details Card */}
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-6 inline-flex flex-col sm:flex-row gap-6 sm:items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Batangas Lakelands</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Oct 11, 2025</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 transition-transform hover:rotate-0 duration-700">
                            <img 
                            ...
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-medium text-lg">RBP Team Building</p>
                                <p className="text-white/70 text-sm">22 Moments Captured</p>
                            </div>
                        </div>
                        {/* Decorative background blob */}
                        <div className="absolute -z-10 top-10 -right-10 w-64 h-64 bg-red-200 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                    </div>
                </div>
            </section>
            ...
            {/* --- SECTION 2: MASONRY GALLERY --- 
                Modern trend: "Pinterest" style columns instead of rigid grids.
                Allows portrait and landscape images to coexist beautifully.
            */}
            ...
            {isOpen && (
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        <img 
                            src={images[currentIndex]} 
                            className="max-h-[85vh] max-w-full rounded shadow-2xl object-contain select-none"
...
export default TeamBuildingModern;