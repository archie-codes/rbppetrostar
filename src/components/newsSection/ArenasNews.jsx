...
// const images = [
//     "/arenas_opening/arenas_opening (11).JPG",
//     "/arenas_opening/arenas_opening (2).JPG",
//     "/arenas_opening/arenas_opening (3).JPG",
//     "/arenas_opening/arenas_opening (4).JPG",
//     "/arenas_opening/arenas_opening (5).JPG",
//     "/arenas_opening/arenas_opening (6).JPG",
//     "/arenas_opening/arenas_opening (7).JPG",
//     "/arenas_opening/arenas_opening (8).JPG",
//     "/arenas_opening/arenas_opening (9).JPG",
//     "/arenas_opening/arenas_opening (10).JPG",
//     "/arenas_opening/arenas_opening (12).JPG",
//     "/arenas_opening/arenas_opening (13).JPG",
// ];
...
//                             <img src="/arenas_opening/arenas_opening (5).JPG" alt="" className="h-auto object-bottom z-0 transition-all duration-300 hover:scale-110" />
//                         </div>
//                         <div className="p-6 space-y-2 lg:col-span-5">
//                             <h3 className="text-2xl text-gray-800 font-semibold sm:text-4xl mb-3">RBP Arenas Station Opening</h3>
...
//                             </span>
//                             <br />
//                             <div className="flex items-center justify-end pt-[150px] ">
//                                 <a href="/Arenas_Station" className="flex items-end justify-end text-md font-semibold text-gray-700 gap-1 mt-5 px-5 sm:px-5">
//                                     VIEW STATION<span aria-hidden="true">→</span>
//                                 </a>
//                             </div>
//                         </div>
//                     </div>
...
import { 
  ...
  ChevronRight, 
  Expand,
  Fuel // Added Fuel icon since this is a station opening
} from "lucide-react";
        ...
        <main className="min-h-screen bg-neutral-50 font-sans selection:bg-red-100 selection:text-red-900">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 z-10" data-aos="fade-right">
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            Expanding our horizons and fueling the future. We are proud to announce the official opening of our newest station in Pampanga.
                        </p>

                        {/* Glassmorphic Details Card */}
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-5 inline-flex flex-col sm:flex-row gap-6 sm:items-center mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Arayat, Pampanga</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">February 18, 2025</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* View Station Link */}
                        <div>
                             <a href="/Arenas_Station" className="text-sm font-bold text-red-600 hover:text-red-700 flex items-center gap-1 group transition-all">
                                VIEW STATION DETAILS <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform"/>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 transition-transform hover:rotate-0 duration-700 group">
                            {/* Using image 5 as the feature, as per original code preference */}
                            <img 
                                ...
                                alt="Station Opening Ribbon Cutting" 
                            />
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-90"></div>
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-bold text-xl">Official Ribbon Cutting</p>
                                <p className="text-white/80 text-sm mt-1">A new milestone for RBP</p>
                            </div>
                        </div>
            ...
            <section className="px-4 pb-24 max-w-[1600px] mx-auto">
                <div className="flex justify-between items-end mb-10 px-2 border-b border-gray-200 pb-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Event Highlights</h2>
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        ...
                        <div className="mt-4 flex flex-col items-center text-white/80">
                            <p className="font-semibold text-lg">Arenas Station Launch</p>
