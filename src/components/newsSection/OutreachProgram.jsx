...
// const images = [
//     "/outreach_program/op (1).jpg",
//     "/outreach_program/op (2).jpg",
//     "/outreach_program/op (3).jpg",
//     "/outreach_program/op (4).jpg",
//     "/outreach_program/op (5).jpg",
//     "/outreach_program/op (7).jpg",
//     "/outreach_program/op (8).jpg",
//     "/outreach_program/op (9).jpg",
//     "/outreach_program/op (10).jpg",
//     "/outreach_program/op (11).jpg",
//     "/outreach_program/op (12).jpg",
//     "/outreach_program/op (14).jpg",
//     "/outreach_program/op (15).jpg",
...
//                             <img src="/outreach_program/op (15).jpg" alt="" className="object-bottom z-0 transition-all duration-300 hover:scale-110" loading="lazy" />
//                         </div>
...
import { 
  ...
  ChevronRight, 
  Expand,
  HeartHandshake // Perfect icon for Outreach
} from "lucide-react";
        ...
        <main className="min-h-screen bg-neutral-50 font-sans selection:bg-red-100 selection:text-red-900">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 z-10" data-aos="fade-right">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-red-600 font-bold tracking-widest text-xs uppercase flex items-center gap-2">
                                <HeartHandshake size={14}/> RBP Cares
                            </span>
                        </div>
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            A weekend of giving back in Lemery, Batangas. Connecting with the community and sharing blessings with those who need it most.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-5 inline-flex flex-col sm:flex-row gap-6 sm:items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Lemery, Batangas</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Dec 07 - 08, 2024</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 transition-transform hover:rotate-0 duration-700 group">
                            {/* Using image 15 as it was the featured one in the original code */}
                            <img 
                            ...
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-bold text-xl">Community Spirit</p>
                                <p className="text-white/80 text-sm mt-1">Sharing smiles & hope</p>
                            </div>
                        </div>
            ...
            <section className="px-4 pb-24 max-w-[1600px] mx-auto">
                <div className="flex justify-between items-end mb-10 px-2 border-b border-gray-200 pb-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Program Highlights</h2>
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        ...
                        <div className="mt-4 flex flex-col items-center text-white/80">
                            <p className="font-semibold text-lg">Lemery Outreach</p>
