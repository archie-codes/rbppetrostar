...
// const images = [
//     "/team_building/team_building (1).jpg",
//     "/team_building/team_building (2).jpg",
//     "/team_building/team_building (3).jpg",
//     "/team_building/team_building (4).jpg",
//     "/team_building/team_building (5).jpg",
//     "/team_building/team_building (6).jpg",
//     "/team_building/team_building (8).jpg",
//     "/team_building/team_building (9).jpg",
//     "/team_building/team_building (10).jpg",
//     "/team_building/team_building (11).jpg",
//     "/team_building/team_building (12).jpg",
//     "/team_building/team_building (13).jpg",
//     "/team_building/team_building (14).jpg",
// ];
...
//                             <img src="/team_building/team_building (14).jpg" alt="" className=" h-auto object-cover z-0 transition-all duration-300 hover:scale-110" loading="lazy" />
//                         </div>
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 z-10" data-aos="fade-right">
                        ...
                        <p className="text-lg text-gray-600 mb-8 max-w-md leading-relaxed">
                            Strengthening bonds and building memories in Morong, Bataan. A weekend of camaraderie, fun, and growth.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-5 inline-flex flex-col sm:flex-row gap-6 sm:items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">Morong, Bataan</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800">April 19 & 20, 2024</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative" data-aos="fade-left" data-aos-delay="100">
                        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 transition-transform hover:rotate-0 duration-700 group">
                            {/* Using image 14 as the featured image per original code */}
                            <img 
                                ...
                                alt="Team Building Main" 
                            />
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-90"></div>
                            <div className="absolute bottom-8 left-8 text-white">
                                <p className="font-bold text-xl">One Team, One Goal</p>
                                <p className="text-white/80 text-sm mt-1">Creating memories together</p>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div className="relative z-40 max-w-7xl w-full h-full flex flex-col items-center justify-center p-4">
                        ...
                        <div className="mt-4 flex flex-col items-center text-white/80">
                            <p className="font-semibold text-lg">Morong Team Building</p>
