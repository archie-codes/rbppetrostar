            ...
            <section className="container pt-5 md:pt-32 mb-36 isolate overflow-hidden lg:overflow-visible">
                <div className="mx-auto flex flex-col items-start justify-start text-left mb-5 px-5 sm:py-5">
                    <h1
                        ...
                        ⸻ NUEVA ECIJA STATIONS
                    </h1>
                    <p
                        data-aos="fade-right"
                        data-aos-duration="400"
                        data-aos-once="true"
                        className="mt-2 text-lg text-gray-600">Here our Stations in Nueva Ecija</p>
                </div>

                <div
                    data-aos="fade-up"
                    data-aos-duration="400"
                    data-aos-once="true" className="mb-10 h-full w-full flex">
                    <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-4 md:p-2 xl:p-5">
                        ...
                        <div
                            ...
                            <div>
                                <div className="relative p-2 flex justify-center">
                                    <a href="/Sta_Rosa_Station">
                                        <img classNames="rounded-md shadow-lg "
                                            src="/stations/sta rosa/sta rosa_main.jpg"
                                            loading="lazy" />
                                    </a>
                                </div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href='/Sta_Rosa_Station' className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                        ...
                        <div
                            ...
                            <div>
                                <div className="relative p-2 flex justify-center">
                                    <a href="/Talavera_Station">
                                        <img classNames="rounded-md shadow-lg "
                                            src="/stations/talavera/talavera_main.jpg"
                                            loading="lazy" />
                                    </a>
                                </div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href='/Talavera_Station' className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Cabanatuan_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
...
export default NuevaEcijaStationList;