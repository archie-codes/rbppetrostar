            ...
            <section className="container pt-5 md:pt-32 mb-36 isolate overflow-hidden lg:overflow-visible">
                <div className="mx-auto flex flex-col items-start justify-start text-left mb-5 px-5 sm:py-5">
                    ...
                    <p
                        ...
                        data-aos-once="true"
                        className="mt-2 text-lg text-gray-600">Here our stations in Pampanga</p>
                </div>
                ...
                <div
                    ...
                    <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-4 md:p-2 xl:p-5">
                        ...
                        {/* <div
                            ...
                            <div>
                                <div className="relative p-2 flex justify-center">
                                    <a href="/Arenas_Station">
                                        <img classNames="rounded-md shadow-lg"
                                            src="/stations/arenas/arenas_main.jpg"
                                            loading="lazy" />
                                    </a>
                                </div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Arenas_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div>
                                <div className="relative p-2 flex justify-center">
                                    <a href="/Calulut_Station">
                                        <img classNames="rounded-md shadow-lg "
                                            src="/stations/calulut/calulut_station.jpg"
                                            loading="lazy" />
                                    </a>
                                </div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Calulut_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Delapaz_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                        ...
                        <div
                            ...
                            <div>
                                <div className="relative p-2 flex justify-center">
                                    <a href="/Panipuan_Station">
                                        <img classNames="rounded-md shadow-lg "
                                            src="/stations/panipuan/panipuan_main.jpg"
                                            loading="lazy" />
                                    </a>
                                </div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href='/Panipuan_Station' className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Pandan_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Pulungbulu_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/Sindalan_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="relative px-4 pb-3">
                                    <div className="leading-7 transition-all group-hover:text-white/90 ">
                                        ...
                                        <br />
                                        <a href="/SanMatias_Station" className="antialiased text-gray-600 text-sm break-all transition-all duration-300 group-hover:text-white">
                                            Visit Station
                                            {/* &rarr; */}
                                        </a>
                                    </div>
...
export default PampangaStationList;