            ...
            <section className="container pt-5 md:pt-32 isolate overflow-hidden lg:overflow-visible">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-3 gap-4 p-5">
                    ...
                    <div className="sm:col-span-2 sm:row-span-2 ">
                        <img classNames="object-cover" src="/Station.jpg" loading="lazy" />
                        ...
                        <div className="container grid grid-cols-3 mx-auto gap-2 -translate-y-4 md:-translate-y-10">
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={52} suffix=".40" duration={5.75} /></p>
                                </div>
                            </div>
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={53} suffix=".80" duration={5.75} /></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="sm:row-span-2 sm:col-start-3 bg-slate-50">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3231.117594819307!2d120.62733849889638!3d15.091432064543495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f6db1bb44a95%3A0xb9256a2e642365cc!2sDela%20Paz%20Norte%20Phoenix%20Gasoline%20Station!5e1!3m2!1sen!2sph!4v1747630831797!5m2!1sen!2sph"
                    ...
                    <div className=" sm:col-start-3 sm:row-start-3">
                        ...
                        <p className='text-xl pl-8 text-gray-700'>Delapaz, San Fernando, Pampanga</p>
                    </div>
                </div>
            </section>
            <Footer />
...
export default Delapaz_Station