            ...
            <section className="container pt-5 md:pt-32 isolate overflow-hidden lg:overflow-visible">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 p-5">
                    ...
                    <div className="sm:col-span-2 p-0">
                        <img classNames="object-cover" src="/stations/arenas/arenas_main.jpg" loading="lazy" />
                        ...
                        <div className="container hidden md:grid grid-cols-3 mx-auto gap-2 -translate-y-4 md:-translate-y-10">
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={52} suffix=".15" duration={5.75} /></p>
                                </div>
                            </div>
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={54} suffix=".05" duration={5.75} /></p>
                                </div>
                            </div>
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={54} suffix=".45" duration={5.75} /></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="sm:col-start-3 p-0">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d458.1705274629765!2d120.6838783978487!3d15.16444983946762!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396efc344c4930d%3A0x8260ec2b92a71bb2!2sRBP%20Petrostar%20Fuels%20(Arenas)!5e1!3m2!1sen!2sph!4v1747120267047!5m2!1sen!2sph"
                    ...
                    <div className="row-start-2 md:col-span-2 md:col-start-1 md:row-start-2 p-0 ">
                        ...
                        <ul className="gap-10 text-xl mt-1 ml-10 text-gray-700 pb-5">
                            <li>Proposed Convinience Stall : 750 sqm</li>
                            <li>Proposed Commercial Establishment : 3,317.45 sqm</li>
                        </ul>
                        ...
                        <div className="slider-container">
                            <Slider {...settings}>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/top_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/top_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/right_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/right_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/front_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/front_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/left_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/left_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/front_view_3,317.45sqm.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/front_view_3,317.45sqm.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/arenas/lot_for_lease/right_view_3,317.45sqm.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/arenas/lot_for_lease/right_view_3,317.45sqm.jpg")} />
                                </div>
                            </Slider>
                        </div>
                    </div>
                    ...
                    <div className="row-start-4 md:col-start-3 md:row-start-2 p-0">
                        ...
                        <p className='text-xl pl-8 text-gray-700'>Arayat, Pampanga</p>
                    </div>
