            ...
            <section className="container pt-5 md:pt-32 isolate overflow-hidden lg:overflow-visible">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-3 gap-4 p-5">
                    ...
                    <div className="sm:row-span-2 sm:col-start-3 bg-slate-50">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d285.53994502677114!2d120.60016140157926!3d15.130961103164429!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f236f115dccb%3A0xea931bdab94e0463!2sRBP%20Petrostar%20Fuels%20(Pulungbulu)!5e1!3m2!1sen!2sph!4v1747632027896!5m2!1sen!2sph"
                    ...
                    <div className=" sm:col-start-3 sm:row-start-3">
                        ...
                        <p className='text-xl pl-8 text-gray-700'>Angeles, Pampanga</p>
                    </div>
                </div>
            </section>
            <Footer />
...
export default Pulungbulu_Station