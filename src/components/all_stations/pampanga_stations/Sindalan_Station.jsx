            ...
            <section className="container pt-5 md:pt-32 isolate overflow-hidden lg:overflow-visible">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-3 gap-4 p-5">
                    ...
                    {/* Price Update */}
                        <div className="container grid grid-cols-3 mx-auto gap-2 -translate-y-4 md:-translate-y-10">
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={53} suffix=".65" duration={5.75} /></p>
                                </div>
                            </div>
                    ...
                    <div className="sm:row-span-2 sm:col-start-3 bg-slate-50">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d339.64890508825863!2d120.64191453178049!3d15.079224972047676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f14a68d3585d%3A0xf8bc7a5ed453343f!2sRBP%20Petrostar%20Gas%20Station%20Incorporated!5e1!3m2!1sen!2sph!4v1747632445522!5m2!1sen!2sph"
                    ...
                    <div className=" sm:col-start-3 sm:row-start-3">
                        ...
                        <p className='text-xl pl-8 text-gray-700'>Sindalan, San Fernando, Pampanga</p>
                    </div>
                </div>
            </section>
            <Footer />
...
export default Sindalan_Station