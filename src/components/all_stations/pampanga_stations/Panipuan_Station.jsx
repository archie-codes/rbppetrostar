            ...
            <section className="container pt-5 md:pt-32 isolate overflow-hidden lg:overflow-visible">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 p-5">
                    ...
                    <div className="sm:col-span-2 p-0">
                        <img classNames="object-cover" src="/stations/panipuan/panipuan_main.jpg" loading="lazy" />
                        ...
                        <div className="container hidden md:grid grid-cols-3 mx-auto gap-2 -translate-y-4 md:-translate-y-10">
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={53} suffix=".35" duration={5.75} /></p>
                                </div>
                            </div>
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={54} suffix=".70" duration={5.75} /></p>
                                </div>
                            </div>
                            ...
                            <div className="fuelbox grid grid-cols-2 items-center justify-center shadow-lg">
                                ...
                                <div className="">
                                    <p className="font-semibold text-black/70 sm:text-xs md:text-2xl">₱ <CountUp start={100} end={55} suffix=".70" duration={5.75} /></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="sm:col-start-3 p-0">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4569.183425735509!2d120.65780977574745!3d15.105695764509765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f1035f3cbbab%3A0xc5cb0220a5ea174f!2sRBP%20Petrostar%20Fuels%20(Panipuan)!5e1!3m2!1sen!2sph!4v1747626727188!5m2!1sen!2sph"
                    ...
                    <div className="row-start-2 md:col-span-2 md:col-start-1 md:row-start-2 p-0">
                        ...
                        <ul className="gap-10 text-xl mt-1 ml-10 text-gray-700 pb-5">
                            <li>Proposed Commercial Establishment : 1,012.55 sqm</li>
                            <li>Proposed Commercial Establishment : 1,228 sqm</li>
                        </ul>
                        ...
                        <div className="slider-container">
                            <Slider {...settings}>
                                <div>
                                    <img src="/stations/panipuan/lot_for_lease/top_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/panipuan/lot_for_lease/top_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/panipuan/lot_for_lease/front_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/panipuan/lot_for_lease/front_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/panipuan/lot_for_lease/side_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/panipuan/lot_for_lease/side_view.jpg")} />
                                </div>
                                <div>
                                    <img src="/stations/panipuan/lot_for_lease/main_front_view.jpg" alt="Lot Area" className="w-80 md:w-[300px] h-auto mt-2 cursor-pointer rounded-lg" onClick={() => openModal("/stations/panipuan/lot_for_lease/main_front_view.jpg")} />
                                </div>
                            </Slider>
                        </div>
                    </div>
                    ...
                    <div className="row-start-4 md:col-start-3 md:row-start-2 p-0">
                        ...
                        <p className='text-xl pl-8 text-gray-700'>Panipuan, Mexico, Pampanga</p>
                    </div>
                </div>
            </section>
...
export default Panipuan_Station